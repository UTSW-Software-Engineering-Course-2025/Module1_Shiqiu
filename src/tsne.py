...
def compute_y_gradient(pij, qij, Y, y_dist):
    ...
    Input
    ----------
    pij(n, n): numpy.ndarray
        pair wise probability matrix generated from adjustbeta

    qij(n, n): numpy.ndarray
        pair wise probability matrix generated from Y

    Y (n, no_dim): numpy.ndarray
        PCA results of X
    
    y_dist (n, n): numpy.ndarray
        distance matrix of Y
    

    Returns
    -------
    dY (n, no_dims): numpy.ndarray
        gradient of Y
...
def tsne(X,
    ...
    -----------------------------------
    X (n, d): numpy.ndarray
        data input array with dimension
